...
final class Version20260715235000 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Use ICS UID for import_calendar_for_class matching and persist new events as neu changes';
    }
