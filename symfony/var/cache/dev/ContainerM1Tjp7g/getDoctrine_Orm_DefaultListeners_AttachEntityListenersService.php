...
class getDoctrine_Orm_DefaultListeners_AttachEntityListenersService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addEntityListener('App\\Domain\\Class\\Entity\\ClassEntity', 'App\\Infrastructure\\EventListener\\ClassEntityListener', 'postPersist');
        $instance->addEntityListener('App\\Domain\\Class\\Entity\\ClassEntity', 'App\\Infrastructure\\EventListener\\ClassEntityListener', 'postUpdate');
